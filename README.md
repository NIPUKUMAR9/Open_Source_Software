...
A capstone OSS project focused on Git, featuring shell scripts for system reporting, disk auditing, log analysis, and open-source exploration.
# OSS Audit — Git
...
| Field | Details |
|---|---|
| **Student Name** | *Nipu Kumar* |
| **Registration Number** |  *24BAI10626*|
| **Chosen Software** | Git |
